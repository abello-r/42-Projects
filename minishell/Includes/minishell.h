...
/*   Updated: 2025/01/22 20:18:37 by pausanch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		execute_child(t_data *data, t_cmd *cmd,
				int *prev_pipe, int *pipe_fd);

// identifier_execute_and_utils
...
// identifier pid
void		pid_handler_aux(int *p_pipe, int *c_pipe,
